          ...
          if(this.state.interviewDate!=null && !this.state.timeCondition)
          {
            return(
             ...
             return(
              ...
              return(
                <div><InterviewResult applicantId={myapplicantData} resheduleHandler={this.resheduleHandler} interviewDate={this.state.interviewDate} childId={this.state.childId}/></div>
              );
         }
      }
}
